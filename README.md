About tad-multicharge-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/tad-multicharge-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/tad-multicharge-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add tad-multicharge
# for installing globally
pixi global install tad-multicharge
```
...
It is possible to list all of the versions of `tad-multicharge` available on your platform:
...
```
pixi search tad-multicharge --channel conda-forge
```
